...
const CACHE_NAME = 'prototipo-hidrop-nico-v1';
const urlsToCache = [
  '/prototipo-hidrop-nico/',
  '/prototipo-hidrop-nico/index.html',
  '/prototipo-hidrop-nico/manifest.json',
  '/prototipo-hidrop-nico/src/estilo.css',
  '/prototipo-hidrop-nico/src/script.js'
];
...
self.addEventListener('push', (event) => {
  const options = {
    ...
    icon: '/prototipo-hidrop-nico/data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 192 192%22><rect fill=%22%23dc2626%22 width=%22192%22 height=%22192%22 rx=%2240%22/><text x=%2296%22 y=%2296%22 font-size=%22100%22 fill=%22white%22 text-anchor=%22middle%22 dominant-baseline=%22middle%22 font-weight=%22bold%22>H</text></svg>',
    badge: '/prototipo-hidrop-nico/data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 96 96%22><rect fill=%22%23dc2626%22 width=%2296%22 height=%2296%22/></svg>'
  };
